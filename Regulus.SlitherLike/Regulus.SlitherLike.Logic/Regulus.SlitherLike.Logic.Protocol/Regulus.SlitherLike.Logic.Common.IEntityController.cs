    ...
    { 
        public class CIEntityController : Regulus.SlitherLike.Logic.Common.IEntityController , Regulus.Remote.IGhost
        {
            ...
            public CIEntityController(long id, bool have_return )
            {                                
            ...
            event Regulus.Remote.EventNotifyCallback Regulus.Remote.IGhost.RemoveEventEvent
            {
                ...
                void Regulus.SlitherLike.Logic.Common.IEntityController.SetDirection()
                {                    

                    Regulus.Remote.IValue returnValue = null;
                    var info = typeof(Regulus.SlitherLike.Logic.Common.IEntityController).GetMethod("SetDirection");
